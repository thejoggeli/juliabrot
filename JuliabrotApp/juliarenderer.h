...
class JuliaRenderer : public QObject
{
 ...
 public:
   ...
   * \param scale_factor multiplicator for camera.zoom, used to keep zoom
   * consistent for different quality settings
   */
